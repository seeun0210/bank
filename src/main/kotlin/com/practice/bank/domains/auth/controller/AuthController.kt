package com.practice.bank.domains.auth.controller

import com.practice.bank.domains.auth.service.AuthService
...
class AuthController(
    ...
    fun callback(
        ...
        return ResponseEntity.status(HttpStatus.FOUND).location(URI.create("http://localhsot:3000")).build()
    }
